...
const DEFAULT_TEMPLATES = [
  ...
  {
    template_key: 'follow_up_reminder_before',
    name: 'Follow-up Reminder (Day Before)',
    recipient_type: 'team',
    description: "Sent to admin/sales the day before a lead's follow-up date.",
    subject: 'Follow-up Tomorrow: {{full_name}} ({{company_name}})',
    body_html: `<p>TODO: write this reminder email, then activate it.</p>`,
    available_variables: ['full_name', 'company_name', 'email', 'phone', 'classification', 'current_stage', 'follow_up_date'],
  },
  {
    template_key: 'follow_up_reminder_due',
    name: 'Follow-up Reminder (Due Today)',
    recipient_type: 'team',
    description: "Sent to admin/sales on the day of a lead's follow-up date.",
    subject: 'Follow-up Due Today: {{full_name}} ({{company_name}})',
    body_html: `<p>TODO: write this reminder email, then activate it.</p>`,
    available_variables: ['full_name', 'company_name', 'email', 'phone', 'classification', 'current_stage', 'follow_up_date'],
  },
  {
